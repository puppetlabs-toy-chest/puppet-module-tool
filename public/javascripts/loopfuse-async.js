/*
Loopfuse Tracking: rewritten for asyncronous operation.

USAGE:

    (function() {
      _lf_track("LF_c268993e");
    })();
*/
...
function _lf_processCookie(thevid) {
    ...
    // And the Lord spake: Thou shalt not use `document.write`, for it is unclean and lothesome unto me.
    ...
    var _lf_node = document.createElement('script');
    _lf_node.setAttribute('type', 'text/javascript');
    _lf_node.setAttribute('src', "http" + (window.location.protocol.indexOf("https:") == 0 ? "s" : "") + "://" + _lf_loopfuseVIDURL);
    document.documentElement.firstChild.appendChild(_lf_node);
}
